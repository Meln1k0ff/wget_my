#############################################################################
# Makefile for building: wget_my
# Generated by qmake (3.1) (Qt 5.9.5)
# Project:  wget_my.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile wget_my.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = wget_my1.0.0
DISTDIR = /home/ubi/wget/wget_my/.tmp/wget_my1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  
AR            = ar cqs
...
Makefile: wget_my.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
connect.o: connect.c connect.h \
		...
		host.h \
		options.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o connect.o connect.c

host.o: host.c host.h \
		options.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o host.o host.c
...
iri.o: iri.c iri.h \
		options.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o iri.o iri.c
...
retr.o: retr.c retr.h \
		url.h \
		iri.h \
		http.h \
		host.h \
		options.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o retr.o retr.c

url.o: url.c url.h \
		iri.h \
		utils.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o url.o url.c
